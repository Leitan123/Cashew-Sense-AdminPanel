<x-app-layout>
    ...
    <div class="bg-white rounded-xl border border-gray-200">
        <div class="p-5 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-[#2c3e2d]">Current CashewSense Users</h3>
            <p class="text-sm text-gray-500 mt-1">Manage all registered customers</p>
        </div>
            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-[#f8f9f5] border-b border-gray-200">
                        ...
                        <th class="px-5 py-3 text-left text-xs font-semibold text-[#4f7942] uppercase tracking-wider">Emp. Code</th>
                ...
                <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-5 py-4 text-sm text-gray-500">
                                @if($customer->employee_code)
                                    <span class="px-2 py-1 text-xs font-semibold rounded-md bg-blue-50 text-blue-700">
                    ...
                    @empty
                        <tr>
                            <td colspan="9" class="px-5 py-8 text-sm text-center text-gray-400">
