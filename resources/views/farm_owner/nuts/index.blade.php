<x-farm-owner-app-layout>
    ...
    <div class="bg-white rounded-xl border border-gray-200">
        <div class="p-5 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-[#2c3e2d]">Cashew Nut Quality Scans</h3>
            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-[#f8f9f5] border-b border-gray-200">
                        ...
                        <th class="px-5 py-3 text-left text-xs font-semibold text-[#4f7942] uppercase tracking-wider">Weight (g)</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($scans as $scan)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-5 py-4 text-sm text-gray-500">{{ str_replace('_', ' ', $scan->predicted_class) }}</td>
                            <td class="px-5 py-4 text-sm text-gray-500">{{ $scan->weight }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="px-5 py-8 text-sm text-center text-gray-400">
                                No nut scans recorded for your customers yet.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
