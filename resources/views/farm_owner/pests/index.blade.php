<x-farm-owner-app-layout>
    ...
    <div class="bg-white rounded-xl border border-gray-200">
        <div class="p-5 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-[#2c3e2d]">Pest Detection Scans</h3>
            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-[#f8f9f5] border-b border-gray-200">
                        ...
                        <th class="px-5 py-3 text-left text-xs font-semibold text-[#4f7942] uppercase tracking-wider">Detected Pest</th>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-5 py-8 text-sm text-center text-gray-400">
                                No pest scans recorded for your customers yet.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
