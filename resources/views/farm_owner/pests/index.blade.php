        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 overflow-x-auto">
                    ...
                    <h3 class="text-lg font-medium mb-4 text-[#2c3e2d]">AI Pest Detections for Your Customers</h3>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-[#f5f5dc]">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-[#4f7942] uppercase tracking-wider">Detected Pest</th>
